...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/15 21:36:39 by seozkan           #+#    #+#             */
/*   Updated: 2024/04/15 21:36:42 by seozkan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T> Array<T>::Array(const Array<T> &a) : _array(new T[a._size]), _size(a._size)
{
